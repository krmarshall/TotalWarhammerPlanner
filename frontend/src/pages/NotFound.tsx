...
const NotFound = () => {
  ...
  return (
    <div className="h-[88vh] bg-gray-700 w-full border border-gray-500 rounded-md px-2 py-2 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-600">
      <div className="flex flex-col place-content-center mt-4 mx-64 select-text font-[Helvetica] text-gray-200">
        ...
        <img src={snek} className="w-7/12 mx-auto mt-8" alt="snek" width="4032" height="3024" />
      </div>
    </div>
  );
};
