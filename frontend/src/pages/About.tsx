    ...
    <div className="h-[88vh] bg-gray-700 w-full border border-gray-500 rounded-md px-2 py-2 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-600">
      <div className="flex flex-col place-content-center mt-2 mx-64 select-text font-[Helvetica]">
        ...
        <p className="text-center text-gray-200 text-2xl">
          ...
          Warhammer 2/3 and various mods for both titles. Want to figure what all the various lords and heroes actually
          do without recruiting each of them? Check what various overhaul mods have done to your favorite units? Help
          someone new to Total Warhammer figure out how to build characters? Or maybe your just a giant nerd like me and
          want to plan out what skills your going to have to skip. These are some of the things I wanted to address with
          this tool and hopefully you find it useful!
        </p>
        ...
        <p className="text-center text-gray-200 text-2xl mb-8">
          Some general items I would like to add/improve in the future, nothing is set in stone but if its listed here
          I&apos;ve at least thought about it. Your support means I have more time to work on, and extend this list!
        </p>
