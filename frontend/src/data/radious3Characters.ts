...
const radious3Characters = {
  ...
  wh_dlc03_bst_beastmen_lords: {
    ...
    bst_exalted_shaman_nurgle: { name: 'Exalted Shaman (Nurgle)', spellLore: 'nurgle' },
    bst_exalted_shaman_slaanesh: { name: 'Exalted Shaman (Slaanesh)', spellLore: 'slaanesh' },
    bst_exalted_shaman_tzeentch: { name: 'Exalted Shaman (Tzeentch)', spellLore: 'tzeentch' },
  },
  ...
  wh3_main_ogr_ogre_kingdoms_lords: {
    ...
    ogr_slaughtermaster_death: { name: 'Slaughtermaster (Death)', spellLore: 'death' },
    ogr_slaughtermaster_heavens: { name: 'Slaughtermaster (Heavens)', spellLore: 'heavens' },
  },
  ...
  wh3_main_tze_tzeentch_lords: {
    ...
    tze_renegade_sorcerer_dark: { name: 'Renegade Sorcerer (Dark)', spellLore: 'dark' },
    tze_renegade_sorcerer_death: { name: 'Renegade Sorcerer (Death)', spellLore: 'death' },
    tze_renegade_sorcerer_shadows: { name: 'Renegade Sorcerer (Shadows)', spellLore: 'shadows' },
  },
