...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (9 Sep 2023)",
      "Mixu's Mousillon (9 Sep 2023)",
      'Gnoblar Hordes - The Unwashed Masses (8 Sep 2023)',
  ...
  cat3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      "Cataph's Southern Realms (TEB) (8 Sep 2023)",
      "Cataph's Kraka Drak: the Norse Dwarfs (11 Sep 2023)",
  ...
  scm3: {
    ...
    includes: [
      ...
      'Skaven Clans (12 Sep 2023)',
      'Rotblood Tribe (6 Sep 2023)',
      'JBV: Curse of Nongchang (9 Sep 2023)',
      'JBV: Islanders of the Moon (10 Sep 2023)',
      'Dynasty of the Damned (10 Sep 2023)',
      "Sigmar's Heirs (12 Sep 2023)",
      'Empire Secessionists (7 Sep 2023)',
      'The Gnoblar Horde (31 Aug 2023)',
      "Dead's Cult of the Possessed (31 Aug 2023)",
      'Karanak (31 Aug 2023)',
      'RotJS : Yin-Yin, the Sea Dragon (10 Sep 2023)',
