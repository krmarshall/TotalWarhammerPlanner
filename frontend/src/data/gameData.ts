...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (2 Sep 2023)",
      "Mixu's Mousillon (3 Sep 2023)",
      'Gnoblar Hordes - The Unwashed Masses (1 Sep 2023)',
      "Mixu's Slayer (5 Sep 2023)",
      "Mixu's Shadowdancer (31 Aug 2023)",
    ],
  ...
  cat3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      "Cataph's Southern Realms (TEB) (3 Sep 2023)",
      "Cataph's Kraka Drak: the Norse Dwarfs (31 Aug 2023)",
  ...
  ovn3: {
    ...
    includes: [
      ...
      'Dread King Legions (1 Sep 2023)',
      'Fimir (1 Sep 2023)',
      'Grudgebringers (4 Sep 2023)',
    ],
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Marienburg (5 Sep 2023)',
      'Skaven Clans (31 Aug 2023)',
      'Rotblood Tribe (2 Sep 2023)',
      'The Jade-Blooded Vampires: Curse of Nongchang (3 Sep 2023)',
      'Dynasty of the Damned (20 Jun 2023)',
      "Sigmar's Heirs, an Empire Overhaul (1 Sep 2023)",
      'Empire Secessionists (3 Sep 2023)',
      'The Gnoblar Horde (31 Aug 2023)',
      "Dead's Cult of the Possessed (31 Aug 2023)",
      'Karanak, Hound of Vengeance (31 Aug 2023)',
      'Roar of the Jade Sea : Yin-Yin, the Sea Dragon (3 Sep 2023)',
      'Cathay Gate Master (2 Sep 2023)',
      'Ivan Radinov - Commander of the Gryphon Legion (31 Aug 2023)',
      "Dead's Kislev Droyashka (2 Sep 2023)",
      "Dead's Kislev Shaman (9 May 2023)",
      "Garbag's Cunnin' Alliance (31 Aug 2023)",
      'Dark Land Orcs (5 Sep 2023)',
