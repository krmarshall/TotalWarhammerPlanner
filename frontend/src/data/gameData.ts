...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (14 Apr 2023)",
      'Gnoblar Hordes - The Unwashed Masses (31 Mar 2023)',
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'The Jade-Blooded Vampires: Curse of Nongchang (11 Apr 2023)',
      'Rotblood Tribe (13 Apr 2023)',
      'Marienburg: The Merchant Empire (1 Apr 2023)',
      "Sigmar's Heirs, an Empire Overhaul (14 Apr 2023)",
      'Empire Secessionists, Secede! (11 Mar 2023)',
      'The Gnoblar Horde (13 Apr 2023)',
      'Karanak, Hound of Vengeance (14 Apr 2023)',
      'Ivan Radinov - Commander of the Gryphon Legion (14 Apr 2023)',
      ...
      'Clan Treecherik (13 Apr 2023)',
      'Clan Verms (13 Apr 2023)',
      'Pestilent Brotherhood (13 Apr 2023)',
    ],
