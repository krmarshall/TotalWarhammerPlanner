...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  cat3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      "Cataph's Southern Realms (TEB) (28 Oct 2023)",
  ...
  ovn3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Albion (27 Oct Sep 2023)',
      'Citadel of Dusk (17 Oct 2023)',
      'Dread King Legions (27 Oct 2023)',
      'Fimir (2 Nov 2023)',
      'Grudgebringers (26 Oct 2023)',
    ],
  ...
  scm3: {
    ...
    includes: [
      ...
      'Skaven Clans (14 Oct 2023)',
      'Rotblood Tribe (29 Oct 2023)',
      ...
      'Karanak (31 Aug 2023)',
      'RotJS : Yin-Yin, the Sea Dragon (1 Nov 2023)',
