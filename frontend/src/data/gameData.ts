...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: ["Mixu's Legendary Lords (5 Feb 2023)", 'Gnoblar Hordes - The Unwashed Masses (30 Jan 2023)'],
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'The Jade-Blooded Vampires: Curse of Nongchang (10 Feb 2023)',
