...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  cat3: {
    ...
    includes: [
      ...
      "Cataph's High Elf Sea Patrol (8 Oct 2023)",
    ],
  ...
  ovn3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Albion (6 Oct Sep 2023)',
      'Citadel of Dusk (8 Oct 2023)',
      'Dread King Legions (21 Sep 2023)',
      'Fimir (25 Sep 2023)',
      'Grudgebringers (4 Oct 2023)',
    ],
