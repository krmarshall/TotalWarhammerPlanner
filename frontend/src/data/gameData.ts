...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  scm3: {
    ...
    includes: [
      ...
      'Skaven Clans (8 Nov 2023)',
      'Rotblood Tribe (8 Nov 2023)',
      ...
      "Garbag's Cunnin' Alliance (29 Oct 2023)",
      'Dark Land Orcs (17 Sep 2023)',
      "Agemouk's Tomb Kings Extended (6 Oct 2023)",
    ],
