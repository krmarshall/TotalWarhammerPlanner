...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      ...
      'Gnoblar Hordes - The Unwashed Masses (18 Mar 2023)',
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'The Jade-Blooded Vampires: Curse of Nongchang (29 Mar 2023)',
      'Rotblood Tribe (26 Mar 2023)',
      'Marienburg: The Merchant Empire (26 Mar 2023)',
      ...
      'Pestilent Brotherhood (26 Mar 2023)',
    ],
