...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (21 Apr 2023)",
      'Gnoblar Hordes - The Unwashed Masses (15 Apr 2023)',
  ...
  scm3: {
    ...
    includes: [
      ...
      'Clan Verms (15 May 2023)',
      'Pestilent Brotherhood (15 May 2023)',
    ],
