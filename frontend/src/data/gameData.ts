...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'The Jade-Blooded Vampires: Curse of Nongchang (18 Feb 2023)',
      ...
      "Sigmar's Heirs, an Empire Overhaul (19 Mar 2023)",
      'Empire Secessionists, Secede! (11 Mar 2023)',
      'Karanak, Hound of Vengeance (16 Feb 2023)',
      'Pestilent Brotherhood (4 Mar 2023)',
      'Rotblood Tribe (17 Mar 2023)',
