...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'The Jade-Blooded Vampires: Curse of Nongchang (29 Jun 2023)',
      ...
      'Roar of the Jade Sea : Yin-Yin, the Sea Dragon (25 Jun 2023)',
      ...
      'Clan Crooktail (23 Jun 2023)',
      'Clan Treecherik (28 May 2023)',
      'Clan Verms (29 Jun 2023)',
      'Clan Vrrtkin (25 Jun 2023)',
      'Pestilent Brotherhood (25 Jun 2023)',
    ],
