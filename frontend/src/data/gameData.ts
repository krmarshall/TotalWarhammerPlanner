...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: ["Mixu's Legendary Lords (4 Feb 2023)", 'Gnoblar Hordes - The Unwashed Masses (30 Jan 2023)'],
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'The Jade-Blooded Vampires: Curse of Nongchang (3 Feb 2023)',
      ...
      "Sigmar's Heirs, an Empire Overhaul (29 Jan 2023)",
      'Empire Secessionists, Secede! (25 Nov 2022)',
      'Karanak, Hound of Vengeance (22 Nov 2022)',
      'Pestilent Brotherhood (1 Feb 2023)',
