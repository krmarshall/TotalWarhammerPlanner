...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (12 Aug 2023)",
      "Mixu's Mousillon (15 Aug 2023)",
      'Gnoblar Hordes - The Unwashed Masses (12 Aug 2023)',
  ...
  scm3: {
    ...
    includes: [
      ...
      'Roar of the Jade Sea : Yin-Yin, the Sea Dragon (10 Aug 2023)',
      'Cathay Gate Master (27 Aug 2023)',
      'Ivan Radinov - Commander of the Gryphon Legion (26 May 2023)',
      "Dead's Kislev Droyashka (27 Aug 2023)",
      "Dead's Kislev Shaman (9 May 2023)",
      "Garbag's Cunnin' Alliance (13 Aug 2023)",
