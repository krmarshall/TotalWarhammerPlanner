...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (22 Nov 2023)",
      "Mixu's Mousillon (22 Nov 2023)",
  ...
  cat3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      "Cataph's Southern Realms (TEB) (22 Nov 2023)",
      "Cataph's Kraka Drak: the Norse Dwarfs (21 Nov 2023)",
      "Cataph's High Elf Sea Patrol (22 Nov 2023)",
    ],
  ...
  ovn3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Albion (21 Nov Sep 2023)',
      'Citadel of Dusk (21 Nov 2023)',
      'Dread King Legions (21 Nov 2023)',
      'Fimir (21 Nov2 Nov 2023)',
      'Grudgebringers (21 Nov 2023)',
    ],
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Skaven Clans (21 Nov 2023)',
      'Marienburg (21 Nov 2023)',
      'Champions of Undeath (21 Nov 2023)',
      'JBV: Curse of Nongchang (24 Oct 2023)',
      'JBV: Islanders of the Moon (24 Oct 2023)',
      'Dynasty of the Damned (30 Oct 2023)',
      'Tomb Kings Extended (21 Nov 2023)',
      'Rotblood Tribe (21 Nov 2023)',
      "Sigmar's Heirs (21 Nov 2023)",
      'Empire Secessionists (15 Nov 2023)',
      "Garbag's Cunnin' Alliance (21 Nov 2023)",
      'Dark Land Orcs (21 Nov 2023)',
      "Dead's Cult of the Possessed (31 Aug 2023)",
      'Karanak (21 Nov 2023)',
      'RotJS : Yin-Yin, the Sea Dragon (11 Nov 2023)',
      'Cathay Gate Master (22 Nov 2023)',
      'Ivan Radinov (21 Nov 2023)',
