...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  cat3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      "Cataph's Southern Realms (TEB) (4 Nov 2023)",
      "Cataph's Kraka Drak: the Norse Dwarfs (19 Sep 2023)",
      "Cataph's High Elf Sea Patrol (21 Oct 2023)",
    ],
  ...
  ovn3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Albion (9 Nov Sep 2023)',
      'Citadel of Dusk (17 Oct 2023)',
      'Dread King Legions (5 Nov 2023)',
      'Fimir (2 Nov 2023)',
      'Grudgebringers (9 Nov 2023)',
    ],
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Skaven Clans (10 Nov 2023)',
      'Marienburg (8 Nov 2023)',
      'Champions of Undeath (10 Nov 2023)',
      'JBV: Curse of Nongchang (24 Oct 2023)',
      'JBV: Islanders of the Moon (24 Oct 2023)',
      'Dynasty of the Damned (30 Oct 2023)',
      'Tomb Kings Extended (6 Oct 2023)',
      'Rotblood Tribe (10 Nov 2023)',
      "Sigmar's Heirs (22 Oct 2023)",
      'Empire Secessionists (17 Oct 2023)',
      "Garbag's Cunnin' Alliance (10 Nov 2023)",
      'Dark Land Orcs (17 Sep 2023)',
      "Dead's Cult of the Possessed (31 Aug 2023)",
      'Karanak (31 Aug 2023)',
      'RotJS : Yin-Yin, the Sea Dragon (3 Nov 2023)',
      'Cathay Gate Master (16 Sep 2023)',
      'Ivan Radinov (4 Nov 2023)',
