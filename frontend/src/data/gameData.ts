...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  lege3: {
    ...
    updated: '4 Jan 2024',
    category: 'Character Mod Compilation',
    includes: ['Legendary Characters (4 Jan 2024)', "SCM's LCCP (3 Jan 2024)"],
  ...
  cat3: {
    ...
    includes: [
      ...
      "Cataph's Kraka Drak: the Norse Dwarfs (1 Jan 2024)",
  ...
  ovn3: {
    ...
    includes: [
      'Albion (20 Dec 2023)',
      'Citadel of Dusk (23 Dec 2023)',
      'Dread King Legions (28 Dec 2023)',
      'Fimir (29 Dec 2023)',
  ...
  scm3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      'Skaven Clans (4 Jan 2024)',
      'Marienburg (1 Jan 2024)',
      'Champions of Undeath (2 Jan 2024)',
      ...
      'Empire Secessionists (28 Dec 2023)',
