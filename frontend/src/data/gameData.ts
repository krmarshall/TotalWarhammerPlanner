...
const gameData: { [key: string]: GameDataInterface } = {
  ...
  mixu3: {
    ...
    includes: [
      "Mixu's Legendary Lords (31 Aug 2023)",
      "Mixu's Mousillon (31 Aug 2023)",
      'Gnoblar Hordes - The Unwashed Masses (1 Sep 2023)',
      "Mixu's Slayer (31 Aug 2023)",
  ...
  cat3: {
    ...
    category: 'Character Mod Compilation',
    includes: [
      "Cataph's Southern Realms (TEB) (1 Sep 2023)",
  ...
  ovn3: {
    ...
    includes: [
      ...
      'Dread King Legions (23 Aug 2023)',
      'Fimir (29 Aug 2023)',
      'Grudgebringers (23 Aug 2023)',
    ],
  ...
  scm3: {
    ...
    includes: [
      ...
      'Rotblood Tribe (3 Aug 2023)',
      'The Jade-Blooded Vampires: Curse of Nongchang (31 Aug 2023)',
      ...
      'Roar of the Jade Sea : Yin-Yin, the Sea Dragon (1 Sep 2023)',
      'Cathay Gate Master (31 Aug 2023)',
      'Ivan Radinov - Commander of the Gryphon Legion (31 Aug 2023)',
      "Dead's Kislev Droyashka (31 Aug 2023)",
