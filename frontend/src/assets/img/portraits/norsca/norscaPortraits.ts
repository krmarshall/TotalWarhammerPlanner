...
import fimir from './nor_cha_fimir_balefiend_campaign_02_0.webp';
import shamanSorcerer from './nor_cha_shaman_sorcerer_campaign_01_0.webp';

const norscaPortraits = {
  wulfrik,
  throgg,
  azrik,
  marauderChieftain,
...
export default norscaPortraits;
